...
//   }
//   async getGameForAnswer(userId: mongoose.Types.ObjectId, answer: string) {
//     const game = await this.getGameByUserId(userId);
//     const gameQuestions = await this.getQuestions();
//     return new GameFactory(game, userId, gameQuestions, answer);
//   }
//
